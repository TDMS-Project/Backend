...
//    }
    ...
    @PutMapping("/assign/{orderId}/{deliveryPersonId}")
    public Order assignOrderToDeliveryPerson(@PathVariable int orderId, @PathVariable int deliveryPersonId) {
        return adminService.assignOrderToDeliveryPerson(orderId, deliveryPersonId);
    }
